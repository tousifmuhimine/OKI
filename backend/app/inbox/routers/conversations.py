...
async def pause_conversation(
    ...
    await _broadcast_conversation_state(conversation, "conversation.paused")
    return await get_conversation(conversation_id, auth, session)


@router.patch("/conversations/{conversation_id}/resume", response_model=ConversationOut)
async def resume_conversation(
    ...
    await session.commit()
    await session.refresh(conversation)
    await _broadcast_conversation_state(conversation, "conversation.resumed")
    return await get_conversation(conversation_id, auth, session)


@router.patch("/conversations/{conversation_id}/takeover", response_model=ConversationOut)
