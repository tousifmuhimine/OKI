...
INDUSTRY_DEFAULTS = {
    ...
    "study_abroad": {
        ...
        "stages": [
            ...
            {"name": "Document Verification", "probability": 40},
            {"name": "Offer Letter", "probability": 60},
            {"name": "Interview Scheduled", "probability": 70},
            {"name": "Interview Pass/Fail", "probability": 80},
            {"name": "Medical", "probability": 85},
            {"name": "Visa Processing", "probability": 90},
            {"name": "Ticket Processing", "probability": 95},
            {"name": "Ready To Fly", "probability": 98},
            {"name": "Completed", "probability": 100, "is_closed": True},
        ],
        "departments": [
